...
setup(
    ...
    package_dir={'': 'lib'},
    packages=['metarelate', 'metarelate.editor.app', 'metarelate.tests'],
    package_data={'metarelate': ['etc/site.cfg'],
                  'metarelate.editor.app': ['static/*', 'templates/*', 'templatetags/*'],
                  'metarelate.tests': ['results/*/*', 'static/*/*']},
    data_files=[('lib/python2.7/site-packages/metarelate', ['COPYING', 'COPYING.LESSER']),
                ('bin', ['lib/metarelate/editor/metarelate_editor.sh'])],
    author='marqh',

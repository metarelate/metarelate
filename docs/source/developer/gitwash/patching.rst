...
in `metarelate`_ .. |emdash| excellent!
...
::
   ...
   git clone git://github.com/metarelate/metarelate.git
...
Then, send the generated patch files to the `metarelate
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `metarelate mailing list`_.
...
Fork the `metarelate`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/metarelate.git
